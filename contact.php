...
<body>
    ...
    <div class="wrapper">
        ...
        <section class="page-title-area bg-image ptb--80" data-bg-image="assets/img/bg/contact_title_bg.jpg">
            <div class="container">
                <div class="row">
                        ...
                        <div class="row">
                            <div class="col-lg-4 col-md-5 mb-md--50">
                                ...
                                <div class="contact-info mb--30">
                                    <p><i class="fa fa-map-marker"></i>20-22 Wenlock Road <br>London, England, N1 7GU
                                    </p>
                                    <p><i class="fa fa-phone"></i> +44-785-989-0133</p>
