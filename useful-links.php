...
<body>
    ...
    <div class="wrapper">
        ...
        <main class="main-content-wrapper">
            ...
            <!-- Feature Area Start -->
            <section class="feature-area mb--9pt5 codeidentic-mt--3pt5">
                <div class="container">
                    <div class="row no-gutters gutter-lg-30 justify-content-between">
                            ...
                            <div class="feature">
                                ...
                                <div class="feature__info text-center">
                                    <h3 class="feature__title"><a
                                            ...
                                            target="_blank">Companies house</a></h3>
                                </div>
                            </div>
                        </div>
                        <div class="col-xl-3 col-md-4">
                            <div class="feature">
                                ...
                                <div class="feature__info text-center">
                                    <h3 class="feature__title"><a
                                            href="https://www.uktaxcalculators.co.uk/tax-calculators/"
                                            target="_blank">Business Tax Calculator</a></h3>
                                </div>
                            </div>
                        </div>
                    </div>
